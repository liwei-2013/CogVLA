...
class OpenVLAConfig(PrismaticConfig):
    ...
    def __init__(
        ...
        **kwargs: str,
        ...
        if not hasattr(self.text_config, "use_lfp"):
            self.text_config.use_lfp = use_lfp
            self.text_config.lfp_type = lfp_type
            self.text_config.lfp_average_factor = lfp_average_factor
            self.text_config.lfp_enable_film = lfp_enable_film
