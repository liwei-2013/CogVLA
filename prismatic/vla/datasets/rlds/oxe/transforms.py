...
def vlabench_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    return trajectory


def calvin_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # # gripper action is in (close = -1, open = 1) --> clip to 0...1, 0 = close, 1 = open
    # gripper_action = trajectory["action"][:, -1:]
    # gripper_action = tf.clip_by_value(gripper_action, 0, 1)
    # trajectory["action"] = tf.concat(
    #     [
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "aloha_pour_water_dataset": aloha_dataset_transform,
    "aloha_put_the_mark_into_plastic_bucket_dataset": aloha_dataset_transform,
    "aloha_put_the_mark_into_black_box_dataset": aloha_dataset_transform,
    ...
    ### ALOHA ours
    "aloha_fold_the_tshirt_dataset": aloha_dataset_transform,
    "aloha_open_the_drawer_place_the_toy_in_the_drawer_and_then_close_it_dataset": aloha_dataset_transform,
    "aloha_put_the_cube_into_the_plate_and_then_put_the_toy_into_the_bowl_dataset": aloha_dataset_transform,
    "aloha_put_the_left_cube_into_the_plate_dataset": aloha_dataset_transform,
    "aloha_put_the_red_cube_into_the_plate_and_then_pick_the_big_cube_into_the_bowl_dataset": aloha_dataset_transform,
    ### VLABench primitive
    "vlabench_primitive_add_condiment": vlabench_dataset_transform,
    "vlabench_primitive_insert_flower": vlabench_dataset_transform,
    "vlabench_primitive_select_book": vlabench_dataset_transform,
    "vlabench_primitive_select_chemistry_tube": vlabench_dataset_transform,
    "vlabench_primitive_select_drink": vlabench_dataset_transform,
    "vlabench_primitive_select_fruit": vlabench_dataset_transform,
    "vlabench_primitive_select_mahjong": vlabench_dataset_transform,
    "vlabench_primitive_select_painting": vlabench_dataset_transform,
    "vlabench_primitive_select_poker": vlabench_dataset_transform,
    "vlabench_primitive_select_toy": vlabench_dataset_transform,
    "vlabench_primitive_10_tasks": vlabench_dataset_transform,
    ### CALVIN
    "calvin_abc_d": calvin_dataset_transform,
    # "calvin_abcd_d": calvin_dataset_transform,
    # "calvin_d_d": calvin_dataset_transform,
}
