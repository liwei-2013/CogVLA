...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    "aloha_pour_water_dataset": [
        ("aloha_pour_water_dataset", 1.0),
    ],
    "aloha_put_the_mark_into_plastic_bucket_dataset": [
        ("aloha_put_the_mark_into_plastic_bucket_dataset", 1.0),
    ],
    "aloha_put_the_mark_into_black_box_dataset": [
        ("aloha_put_the_mark_into_black_box_dataset", 1.0),
    ],
    ...
    # ============================
    "aloha_fold_the_tshirt_dataset": [
        ("aloha_fold_the_tshirt_dataset", 1.0),
    ],
    "aloha_open_the_drawer_place_the_toy_in_the_drawer_and_then_close_it_dataset": [
        ("aloha_open_the_drawer_place_the_toy_in_the_drawer_and_then_close_it_dataset", 1.0),
    ],
    "aloha_put_the_cube_into_the_plate_and_then_put_the_toy_into_the_bowl_dataset": [
        ("aloha_put_the_cube_into_the_plate_and_then_put_the_toy_into_the_bowl_dataset", 1.0),
    ],
    "aloha_put_the_left_cube_into_the_plate_dataset": [
        ("aloha_put_the_left_cube_into_the_plate_dataset", 1.0),
    ],
    "aloha_put_the_red_cube_into_the_plate_and_then_pick_the_big_cube_into_the_bowl_dataset": [
        ("aloha_put_the_red_cube_into_the_plate_and_then_pick_the_big_cube_into_the_bowl_dataset", 1.0),
    ],
    # ============================
    "vlabench_primitive_add_condiment": [
        ("vlabench_primitive_add_condiment", 1.0)
    ],
    "vlabench_primitive_insert_flower": [
        ("vlabench_primitive_insert_flower", 1.0)
    ],
    "vlabench_primitive_select_book": [
        ("vlabench_primitive_select_book", 1.0)
    ],
    "vlabench_primitive_select_chemistry_tube": [
        ("vlabench_primitive_select_chemistry_tube", 1.0)
    ],
    "vlabench_primitive_select_drink": [
        ("vlabench_primitive_select_drink", 1.0)
    ],
    "vlabench_primitive_select_fruit": [
        ("vlabench_primitive_select_fruit", 1.0)
    ],
    "vlabench_primitive_select_mahjong": [
        ("vlabench_primitive_select_mahjong", 1.0)
    ],
    "vlabench_primitive_select_painting": [
        ("vlabench_primitive_select_painting", 1.0)
    ],
    "vlabench_primitive_select_poker": [
        ("vlabench_primitive_select_poker", 1.0)
    ],
    "vlabench_primitive_select_toy": [
        ("vlabench_primitive_select_toy", 1.0)
    ],
    "vlabench_primitive_10_tasks": [
        ("vlabench_primitive_add_condiment", 1.0),
        ("vlabench_primitive_insert_flower", 1.0),
        ("vlabench_primitive_select_book", 1.0),
        ("vlabench_primitive_select_chemistry_tube", 1.0),
